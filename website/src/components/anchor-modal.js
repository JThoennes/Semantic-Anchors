...
export async function loadAnchorContent(anchorId) {
  ...
  const talkItOverEl = modal.querySelector('#modal-talk-it-over')
  if (talkItOverEl) talkItOverEl.style.display = 'none'
  ...
  try {
    ...
    // Hand the reader the very file we just rendered — same URL, same language,
