...
export const BUNDLES = [
  {
    title: 'Communication & Presentation (1/2)',
    url: 'https://llm-coding.github.io/Semantic-Anchors/bundles/communication-presentation-1.txt',
    terms: [
      '4MAT',
      'AIDA Model',
  ...
  {
    title: 'Communication & Presentation (2/2)',
    url: 'https://llm-coding.github.io/Semantic-Anchors/bundles/communication-presentation-2.txt',
    terms: ['Tufte Style', 'Zone of Proximal Development'],
  },
  {
    title: 'Creative Writing',
    url: 'https://llm-coding.github.io/Semantic-Anchors/bundles/creative-writing.txt',
    terms: [
      'Fichtean Curve',
      "Freytag's Pyramid",
      "Hero's Journey",
  ...
  {
    title: 'Design Principles & Patterns (1/2)',
    url: 'https://llm-coding.github.io/Semantic-Anchors/bundles/design-principles-1.txt',
    terms: [
      'Code Smells',
      'Cohesion Criteria',
      'CRC-Cards',
  ...
  {
    title: 'Design Principles & Patterns (2/2)',
    url: 'https://llm-coding.github.io/Semantic-Anchors/bundles/design-principles-2.txt',
    terms: [
  ...
  },
  {
    ...
    url: 'https://llm-coding.github.io/Semantic-Anchors/bundles/development-workflow.txt',
    terms: [
      '50/72 Rule',
      'BEM Methodology',
  ...
  },
  {
    ...
    url: 'https://llm-coding.github.io/Semantic-Anchors/bundles/dialogue-interaction.txt',
    terms: ['Socratic Method', 'Systemic Consulting (Heidelberg School)', 'XY Problem'],
  },
  {
    title: 'Documentation',
    url: 'https://llm-coding.github.io/Semantic-Anchors/bundles/documentation.txt',
    terms: [
      'Diátaxis Framework',
  ...
  },
  {
    ...
    url: 'https://llm-coding.github.io/Semantic-Anchors/bundles/knowledge-management.txt',
    terms: [
      'ADDIE Model',
  ...
  {
    title: 'Meta',
    url: 'https://llm-coding.github.io/Semantic-Anchors/bundles/meta.txt',
    terms: [
  ...
  },
  {
    ...
    url: 'https://llm-coding.github.io/Semantic-Anchors/bundles/problem-solving.txt',
    terms: [
  ...
  },
  {
    ...
    url: 'https://llm-coding.github.io/Semantic-Anchors/bundles/requirements-engineering.txt',
    terms: [
      'Cockburn Use Cases',
      'Double Diamond',
      'EARS-Requirements',
  ...
  {
    title: 'Software Architecture (1/2)',
    url: 'https://llm-coding.github.io/Semantic-Anchors/bundles/software-architecture-1.txt',
    terms: [
  ...
  {
    title: 'Software Architecture (2/2)',
    url: 'https://llm-coding.github.io/Semantic-Anchors/bundles/software-architecture-2.txt',
    terms: ['Twelve-Factor App', 'Vertical Slice Architecture (VSA)', 'Walking Skeleton'],
  },
  {
    title: 'Statistical Methods & Process Monitoring',
    url: 'https://llm-coding.github.io/Semantic-Anchors/bundles/statistical-methods.txt',
    terms: [
  ...
  },
  {
    ...
    url: 'https://llm-coding.github.io/Semantic-Anchors/bundles/strategic-planning.txt',
    terms: [
  ...
  {
    title: 'Testing & Quality Practices',
    url: 'https://llm-coding.github.io/Semantic-Anchors/bundles/testing-quality.txt',
    terms: [
