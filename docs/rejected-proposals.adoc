...
| Insufficient training-data density
| Attributable to William Zinsser verbatim (_The American Scholar_, 1 December 2009) and real — but it does not act as an anchor. A three-armed action test rewrote the same paragraph three ways: naming Zinsser, naming only the four words without him, and neutrally. All three produced the same rewrite; the name added commentary *about* the principles, not better prose. Both name forms were tested on the weak tier: "Zinsser's four principles" was recognised in 1 of 2 runs, the book's own wording "four articles of faith" in 0 of 2, and across the four runs `thin` was reported three times. Asked who formulated four principles of good English writing, the strong tier answers that no canonical list exists and offers Orwell; the weak tier simply answers Orwell. The prior sits on "Zinsser" and "On Writing Well", not on any four-item formula. +
*No contract added either*: the existing link:#/contracts[Writing Style] contract already names Strunk & White and Wolf Schneider and states eight concrete rules, which four adjectives do not improve on. Full measurement in the link:#/prior-tests[prior-test register]. Proposed in #706.
