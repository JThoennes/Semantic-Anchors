...
| Insufficient training-data density
| Attributable to William Zinsser verbatim (_The American Scholar_, 1 December 2009) and real — but it does not act as an anchor. A three-armed action test rewrote the same paragraph three ways: naming Zinsser, naming only the four words without him, and neutrally. All three produced the same rewrite; the name added commentary *about* the principles, not better prose. On the weak tier the phrase is recognised in 1 of 2 runs and reported `thin` otherwise. The book's own wording, "four articles of faith", measured *worse* (0 of 2). Asked who formulated four principles of good English writing, the strong tier answers that no canonical list exists and offers Orwell; the weak tier simply answers Orwell. The prior sits on "Zinsser" and "On Writing Well", not on any four-item formula. +
