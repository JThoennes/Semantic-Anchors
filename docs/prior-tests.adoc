...
*The spelled-out name beats the specification number on the weak tier.* Asked about "ASD-STE100", Haiku reported `richness=moderate` and `reaching=yes` in both runs; asked about "Simplified Technical English", it recognised the term without reaching in one of two. Opus handles both equally.
