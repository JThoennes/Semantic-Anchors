...
*Einzelbeobachtungen, als solche festgehalten:* Je ein P1-Lauf auf der schwachen Stufe meldete für beide Kandidaten `reaching=yes`. Keiner reproduzierte sich im zweiten Lauf, keiner gilt daher als Befund.
