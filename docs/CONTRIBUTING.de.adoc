...
* `:verified-on:` - Modelle, auf denen der Anker nachweislich *wirkt*, kommagetrennt (z.B. `haiku-4.5, sonnet-5, opus-5`). Wird im Modal angezeigt. Nur eintragen, wo der Anker geliefert hat, nie bloß, wo er ausprobiert wurde -- ein Anker, der auf drei Stufen getestet, auf einer aber nicht von der ankerlosen Baseline unterscheidbar war, führt die anderen zwei
